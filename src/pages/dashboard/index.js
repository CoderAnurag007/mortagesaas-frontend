...
const Overview = () => {
  ...
  const details = [
    {
      info: "Receive signed loan document",
    },
    {
      info: "Receive signed loan document",
    },
  ...
  const notifications = [
    {
      chat: "Review of closing costs for Bryce Mc Laren - Bryce talking with you",
    },
    {
      chat: "Review of closing costs for Bryce Mc Laren - Bryce talking with you",
    },
  ...
  return (
    <>
      ...
      <Container>
        ...
        <Box>
          {/* <TableContainer style={{msOverflowY:'scroll', maxHeight:'500px'}}>
              <Table >
                <TableHead>
                  <TableRow>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Applicant</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>COE</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Amount&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Status&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Purpose&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'250px', fontSize:'16px'}}>Progress Milestones&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Notifications&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Rate&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Loan Officer&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Processor&nbsp;</TableCell>
                    <TableCell align="right" style={{minWidth:'100px', fontSize:'16px'}}>Underwriter&nbsp;</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {dataList.map((data) => (
                    ...
                    >
                      ...
                      <TableCell align="right">{datashow.coe}</TableCell>
                      <TableCell align="right">{datashow.amount}</TableCell>
                      <TableCell align="right">{datashow.status}</TableCell>
                      <TableCell align="right">{datashow.purpose}</TableCell>
                      <TableCell align="right">progress</TableCell>
                      <TableCell align="right">notifications</TableCell>
                      <TableCell align="right">{datashow.rate}</TableCell>
                      <TableCell align="right">{datashow.loanOfficer}</TableCell>
                      <TableCell align="right">{datashow.processor}</TableCell>
                      <TableCell align="right">{datashow.underWriter}</TableCell>
